			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Chuyên Ngoại - Duy Tiên - Hà Nam</a></li>
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
					<li><a href="{{url('update/'.Auth::user()->id)}}"><i class="fa fa-user"></i>{{Auth::user()->name}}</a></li><li><a href="{{route('logout')}}"><i class="fa fa-user"></i>Logout</a></li>
					@else
                             ...
                             src="upload/product/{{$product['item']['images']}}">
										...
										<div class="media-body">
					                        ...
					                        <span class="cart-item-amount">{{$product['qty']}}
					                            *<span>@if($product['item']['p_price']==0){{number_format($product['item']['u_price'])}} @else {{number_format($product['item']['p_price'])}}@endif</span></span>
					                    </div>
									</div>
								</div>
							@endforeach
