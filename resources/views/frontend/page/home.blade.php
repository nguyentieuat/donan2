											...
											<div class="col-sm-3">
												<div class="single-item">
													...
													<div class="single-item-body">
														...
														<p class="single-item-price" style="font-size: 14px;margin-bottom: 5px;">
															@if($prop->p_price==0)
															<span class="flash-sale">{{number_format($prop->u_price)}}</span>
															@else
															<span class="flash-del">{{number_format($prop->u_price)}}</span>
															<span class="flash-sale">{{number_format($prop->p_price)}}</span>
															@endif
														</p>
													</div>
													<div class="single-item-caption">
